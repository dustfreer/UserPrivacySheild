 ...
 * 、按键的高度、忙?词区域的高度?按键气泡宽度比按键宽度大的差忼?按键气泡高度比按键高度大的差忼?正常按键中文本的大尿
...
public class Environment {
	 ...
	 * 猜测：点击软键盘按钮时弹出来的气泡大于按键的宽度的差值，值是相对于屏幕高度和宽度较小的那丿个?
	 */
	 ...
	 * It is relative to the smaller one of screen width and height.
	 * 猜测：点击软键盘按钮时弹出来的气泡大于按键的高度的差值，值是相对于屏幕高度和宽度较小的那丿个?
	 */
	 ...
	 * screen width and height. 正常按键的文本的大小，忼是相对于屏幕高度和宽度较小的那丿个?
	 */
	 ...
	 * screen width and height. 功能按键的文本的大小，忼是相对于屏幕高度和宽度较小的那丿个?
	 */
	 ...
	 * of screen width and height. 正常按键弹出的气泡的文本的大小，值是相对于屏幕高度和宽度较小的那丿个?
	 */
	 ...
	 * one of screen width and height. 功能按键弹出的气泡的文本的大小，值是相对于屏幕高度和宽度较小的那丿个?
	 */
	...
	private int mScreenWidth; // 屏幕的宽庿
	private int mScreenHeight; // 屏幕的高庿
	private int mKeyHeight; // 按键的高庿
	private int mCandidatesAreaHeight; // 候?词区域的高庿
	private int mKeyBalloonWidthPlus; // 按键气泡宽度比按键宽度大的差倿
	private int mKeyBalloonHeightPlus; // 按键气泡高度比按键高度大的差倿
