...
public class SettingsActivity extends PreferenceActivity implements
	...
	//当点击了返回按键时候 ，发送一个广播 传递解码后的二维码值
	@Override
	public void onBackPressed() {
        Log.e("SettingActivity", "onBackPressed");
		
		Intent qrIntent = new Intent();
		qrIntent.setAction("android.intent.QRCode");
		qrIntent.putExtra("qrCodeString", "successQRCode");
		sendBroadcast(qrIntent);
