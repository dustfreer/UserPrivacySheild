...
public class XmlKeyboardLoader {
	 ...
	 * {@link #XMLTAG_SKB_TEMPLATE} and {@link #XMLTAG_KEYBOARD}. xml标签中的属濿
	 */
	 ...
	 * calculate its own position. xml标签中的属濿
	 */
	 ...
	 * {@link #XMLTAG_TOGGLE_STATE} xml标签中的属濿
	 */
	private static final String XMLATTR_TOGGLE_STATE_ID = "state_id";

	/** Attribute tag of key template for the soft keyboard. xml标签中的属濿 */
	 ...
	 * specifies the default value. xml标签中的属濿
	 */
	...
	/**
	 * 解析丿个按键，其中调用getToggleStates（）解析ToggleState按键变换状濁?
	 * 
	 * @param xrp
	 * @param attrKey
	 * @return
