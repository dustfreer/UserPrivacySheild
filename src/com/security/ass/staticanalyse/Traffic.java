		    ...
		    if(TrafficStats.getMobileTxBytes()>a||TrafficStats.getMobileTxBytes()==a)
		    {
			 ...
			 editor.putLong("gprs_rev", TrafficStats.getMobileRxBytes()+d);
		      ...
		      a=TrafficStats.getMobileTxBytes();
			   ...
			   if(!now.equals(yet)){
				   if(getCurrentTime()[1]>preferences2.getInt("mouth", 2)&&getCurrentTime()[2]>preferences2.getInt("overday", 1)){
...
//			   Log.v("fuck", getCurrentTime()[1]+"ss"+preferences2.getInt("mouth", 2)+"aa"+getCurrentTime()[2]+"PP"+preferences2.getInt("overday", 1));
		return gprs;
	   }
	   ...
	   public long[] getAllWifi(){
		   ...
		   long h=preferences.getLong("wifi_rev", 0);
		    if(TrafficStats.getTotalTxBytes()-TrafficStats.getMobileTxBytes()>e||TrafficStats.getTotalTxBytes()-TrafficStats.getMobileTxBytes()==e)
		    {
